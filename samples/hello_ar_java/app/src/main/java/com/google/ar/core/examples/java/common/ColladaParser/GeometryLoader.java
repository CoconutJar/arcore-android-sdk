...
public class GeometryLoader {
    ...
    private final NodeList meshData;
    ...
    public GeometryLoader(NodeList geometryNode, List<VertexSkinData> vertexWeights) {
    ...
    private void readPositions() {
        ...
        Node positionsData = meshData.getChildWithAttribute("source", "id", positionsId).getChild("float_array");
    ...
    private void readNormals() {
        ...
        Node normalsData = meshData.getChildWithAttribute("source", "id", normalsId).getChild("float_array");
    ...
    private void readTextureCoords() {
        String texCoordsId = meshData.getChild("polylist").getChildWithAttribute("input", "semantic", "TEXCOORD")
                .getAttribute("source").substring(1);
        Node texCoordsData = meshData.getChildWithAttribute("source", "id", texCoordsId).getChild("float_array");
    ...
    private void assembleVertices(){
        Node poly = meshData.getChild("polylist");
